...
class CommentairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commentaire" do
    assert_difference("Commentaire.count") do
      post commentaires_url, params: { commentaire: { content: @commentaire.content, rate: @commentaire.rate } }
    end
  ...
  test "should update commentaire" do
    patch commentaire_url(@commentaire), params: { commentaire: { content: @commentaire.content, rate: @commentaire.rate } }
